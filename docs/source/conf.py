...
project = 'ESP32 MPU Driver'
copyright = u'2018, Natanael Josué Rabello'
...
htmlhelp_basename = 'MPUDriverdoc'
...
latex_documents = [
    (master_doc, 'MPUDriver.tex', 'MPU Driver Documentation',
     'Natanael Rabello', 'manual'),
]
...
man_pages = [
    (master_doc, 'mpudriver', 'MPU Driver Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'MPUDriver', 'MPU Driver Documentation',
     author, 'MPUDriver', 'One line description of project.',
     'Miscellaneous'),
]
